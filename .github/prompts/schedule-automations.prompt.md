...
If the user says they're not sure or asks for a recommendation, suggest: **Morning Triage + Milestone Review** as the starter set — these two cover daily prep and weekly team health, which gives the most immediate value.
